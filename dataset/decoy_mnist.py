...
SAVE_PATH = os.path.join(DATA_PATH, "decoy_mnist")
...
def load_decoyMNIST(seed: int = 123, reload: bool = True, bias_ratio:list=[1]*10, variation: int= 0) -> tuple:
  """Load DecoyMNIST dataset.
  Args:
    seed (int): seed for reproducibility.
    reload (bool): flag to reload dataset.
  Returns:
    Tuple[DecoyMNIST, DecoyMNIST, DecoyMNIST]: train, val and test set.
  """
  return load_decoy(
    save_path=SAVE_PATH,
